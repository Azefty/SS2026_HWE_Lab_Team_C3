...
- Custom PCB concept (in progress, Altium — targeting a Lattice MachXO2-640HC)
...
| Task | Team |
|------|------|
| VHDL design & RTL implementation (`debounce_pulse`, `parking_top`) + technical documentation | Jaleel Ur Rehman, Zulkar Nain Sayeed |
| Functional simulation & verification (testbench: reset, password checks, entry/exit sequencing) | Zulkar Nain Sayeed, MD Efty |
| Synthesis, implementation & hardware bring-up on the Nexys A7-100T |MD Efty, Muhammad Umar Hayat |
| PCB design in Altium Designer (schematic capture, routing, 3D render) | Muhammad Umar Hayat, Jaleel Ur Rehman |
