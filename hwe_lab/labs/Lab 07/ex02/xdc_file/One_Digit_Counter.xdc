...
## ------------------------------------------------------------
## START_STOP -- SW0 (leftmost used switch)
## Slide UP   = '1' = counting
## Slide DOWN = '0' = paused
## ------------------------------------------------------------
...
## ------------------------------------------------------------
## CLEAR -- BTNC (centre push-button)
## Press = '1' = reset count to 0
## ------------------------------------------------------------
...
## ------------------------------------------------------------
## Decimal point (held OFF in VHDL)
## ------------------------------------------------------------
set_property -dict { PACKAGE_PIN H15  IOSTANDARD LVCMOS33 } [get_ports { dp }];

## ------------------------------------------------------------
## Anode select -- only AN0 (rightmost digit) is active in VHDL
## ------------------------------------------------------------
