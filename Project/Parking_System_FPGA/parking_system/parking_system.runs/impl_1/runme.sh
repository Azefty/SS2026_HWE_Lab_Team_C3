...
HD_PWD='C:/Users/cw_98/Documents/Parking_System_FPGA/parking_system/parking_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parking_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parking_top.tcl -notrace
