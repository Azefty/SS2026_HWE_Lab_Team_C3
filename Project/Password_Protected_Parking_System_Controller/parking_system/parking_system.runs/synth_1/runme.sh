...
HD_PWD='C:/Users/cw_98/Documents/Parking_System_FPGA/parking_system/parking_system.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parking_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parking_top.tcl
