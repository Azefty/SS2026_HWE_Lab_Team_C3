...
REM
REM Generated by Vivado on Tue Jun 30 16:32:10 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_parking_top_vhdl.prj"
call xvhdl  --incr --relax -prj tb_parking_top_vhdl.prj -log xvhdl.log
